  ...
  return (
    <div className='p-20'>
      ...
      <form action='/api/post/update' method='post'>
        ...
        <input name='title' type='text' placeholder='제목을 입력해 주세요' defaultValue={result.title} required />
        <input name='content' type='text' placeholder='내용을 입력해 주세요' defaultValue={result.content} required />
        <button>수정하기</button>
      </form>
    </div>
  )
